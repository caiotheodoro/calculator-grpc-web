...
export interface ICalculatorClient {
    ...
    /**
     * @generated from protobuf rpc: Subtract(calculator.CalculationRequest) returns (calculator.CalculationResponse);
     */
    subtract(input: CalculationRequest, options?: RpcOptions): UnaryCall<CalculationRequest, CalculationResponse>;
    /**
     * @generated from protobuf rpc: Multiply(calculator.CalculationRequest) returns (calculator.CalculationResponse);
     */
    multiply(input: CalculationRequest, options?: RpcOptions): UnaryCall<CalculationRequest, CalculationResponse>;
}
/**
 * @generated from protobuf service calculator.Calculator
 */
